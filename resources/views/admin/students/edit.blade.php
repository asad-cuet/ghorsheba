                                ...
                                <div class="thinborder-ontop">
                                    ...
                                    <form id="userloginform" method="POST" action="{{route('admin.students.update',$student->id)}}" enctype="multipart/form-data">   
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="student_id" type="number" class="form-control" name="student_id" value="{{$student->student_id}}" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="name"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="room_no" type="number" class="form-control" name="room_no" value="{{$student->room_no}}" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="phone"
                                            ...
                                            <div class="col-md-6">
                                                <input id="phone" type="number" class="form-control" name="phone" value="{{$student->phone}}" required="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
